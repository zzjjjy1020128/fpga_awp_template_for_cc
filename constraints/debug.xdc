...
#------------------------------------------------------------------------------
# dbg_hub clock now follows ILA core clock (FCLK_CLK0 via BD connection).
# create_generated_clock removed: dbg_hub/clk does not exist at XDC parse time
# (generated by opt_design Phase 1), so the constraint always failed.
#
# 探针分配计划:
