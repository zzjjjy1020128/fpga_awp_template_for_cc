# =============================================================================
# run_full_flow.tcl — 重跑 L2 综合 + L3 实现（shift_addr_gen 流水线化后验证时序收敛）
...
# 生成综合报告
report_utilization -file [file join $script_dir utilization.rpt]
report_timing_summary -file [file join $script_dir timing_summary.rpt]
report_qor_suggestions -file [file join $script_dir qor_suggestions.rpt]
